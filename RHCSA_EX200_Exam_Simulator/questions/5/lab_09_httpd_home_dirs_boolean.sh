#!/usr/bin/env bash
IS_LAB=true
LAB_ID="lab_09_httpd_home_dirs_boolean"
QUESTION="Sta toe dat httpd content uit user home directories leest."
LAB_TASK_COUNT=1
TASK_1_QUESTION="Boolean httpd_enable_homedirs moet aan staan."
