...
# LAB: Networking and firewalld firewall-http 28
# Converted from qdir format: q028-rhcsa-07-028

IS_LAB=true
LAB_ID="rhcsa_07_028"
QUESTION="Networking and firewalld firewall-http 28"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-http 28"
