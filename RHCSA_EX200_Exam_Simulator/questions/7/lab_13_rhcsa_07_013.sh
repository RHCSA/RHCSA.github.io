...
# LAB: Networking and firewalld hostname 13
# Converted from qdir format: q013-rhcsa-07-013

IS_LAB=true
LAB_ID="rhcsa_07_013"
QUESTION="Networking and firewalld hostname 13"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld hostname 13"
