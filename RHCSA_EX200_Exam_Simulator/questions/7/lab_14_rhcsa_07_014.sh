...
# LAB: Networking and firewalld dns 14
# Converted from qdir format: q014-rhcsa-07-014

IS_LAB=true
LAB_ID="rhcsa_07_014"
QUESTION="Networking and firewalld dns 14"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld dns 14"
