...
# LAB: Networking and firewalld dns 8
# Converted from qdir format: q008-rhcsa-07-008

IS_LAB=true
LAB_ID="rhcsa_07_008"
QUESTION="Networking and firewalld dns 8"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld dns 8"
