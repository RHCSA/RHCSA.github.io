...
# LAB: Networking and firewalld firewall-http 4
# Converted from qdir format: q004-rhcsa-07-004

IS_LAB=true
LAB_ID="rhcsa_07_004"
QUESTION="Networking and firewalld firewall-http 4"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-http 4"
