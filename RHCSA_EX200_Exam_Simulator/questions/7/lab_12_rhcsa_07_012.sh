...
# LAB: Networking and firewalld firewall-rich 12
# Converted from qdir format: q012-rhcsa-07-012

IS_LAB=true
LAB_ID="rhcsa_07_012"
QUESTION="Networking and firewalld firewall-rich 12"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-rich 12"
