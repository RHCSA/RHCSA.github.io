...
# LAB: Networking and firewalld hostname 1
# Converted from qdir format: q001-rhcsa-07-001

IS_LAB=true
LAB_ID="rhcsa_07_001"
QUESTION="Networking and firewalld hostname 1"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld hostname 1"
