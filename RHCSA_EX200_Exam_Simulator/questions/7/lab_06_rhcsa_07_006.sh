...
# LAB: Networking and firewalld firewall-rich 6
# Converted from qdir format: q006-rhcsa-07-006

IS_LAB=true
LAB_ID="rhcsa_07_006"
QUESTION="Networking and firewalld firewall-rich 6"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-rich 6"
