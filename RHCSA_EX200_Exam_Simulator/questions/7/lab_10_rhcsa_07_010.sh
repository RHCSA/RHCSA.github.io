...
# LAB: Networking and firewalld firewall-http 10
# Converted from qdir format: q010-rhcsa-07-010

IS_LAB=true
LAB_ID="rhcsa_07_010"
QUESTION="Networking and firewalld firewall-http 10"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-http 10"
