...
# LAB: Networking and firewalld dns 2
# Converted from qdir format: q002-rhcsa-07-002

IS_LAB=true
LAB_ID="rhcsa_07_002"
QUESTION="Networking and firewalld dns 2"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld dns 2"
