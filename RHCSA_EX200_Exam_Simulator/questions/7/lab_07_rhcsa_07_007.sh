...
# LAB: Networking and firewalld hostname 7
# Converted from qdir format: q007-rhcsa-07-007

IS_LAB=true
LAB_ID="rhcsa_07_007"
QUESTION="Networking and firewalld hostname 7"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld hostname 7"
