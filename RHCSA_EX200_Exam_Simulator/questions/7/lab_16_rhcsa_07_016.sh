...
# LAB: Networking and firewalld firewall-http 16
# Converted from qdir format: q016-rhcsa-07-016

IS_LAB=true
LAB_ID="rhcsa_07_016"
QUESTION="Networking and firewalld firewall-http 16"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-http 16"
