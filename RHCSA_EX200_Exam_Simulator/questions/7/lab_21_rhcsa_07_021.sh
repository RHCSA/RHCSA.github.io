...
# LAB: Networking and firewalld nmcli 21
# Converted from qdir format: q021-rhcsa-07-021

IS_LAB=true
LAB_ID="rhcsa_07_021"
QUESTION="Networking and firewalld nmcli 21"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld nmcli 21"
