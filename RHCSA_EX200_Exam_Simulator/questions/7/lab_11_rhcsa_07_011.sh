...
# LAB: Networking and firewalld firewall-8080 11
# Converted from qdir format: q011-rhcsa-07-011

IS_LAB=true
LAB_ID="rhcsa_07_011"
QUESTION="Networking and firewalld firewall-8080 11"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-8080 11"
