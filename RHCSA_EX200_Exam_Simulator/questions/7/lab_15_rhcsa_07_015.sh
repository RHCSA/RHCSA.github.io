...
# LAB: Networking and firewalld nmcli 15
# Converted from qdir format: q015-rhcsa-07-015

IS_LAB=true
LAB_ID="rhcsa_07_015"
QUESTION="Networking and firewalld nmcli 15"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld nmcli 15"
