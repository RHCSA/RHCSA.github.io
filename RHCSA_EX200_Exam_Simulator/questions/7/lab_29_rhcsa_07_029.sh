...
# LAB: Networking and firewalld firewall-8080 29
# Converted from qdir format: q029-rhcsa-07-029

IS_LAB=true
LAB_ID="rhcsa_07_029"
QUESTION="Networking and firewalld firewall-8080 29"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-8080 29"
