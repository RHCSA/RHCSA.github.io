...
# LAB: Networking and firewalld firewall-8080 17
# Converted from qdir format: q017-rhcsa-07-017

IS_LAB=true
LAB_ID="rhcsa_07_017"
QUESTION="Networking and firewalld firewall-8080 17"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-8080 17"
...
# Task 2
TASK_2_QUESTION="Open TCP/8080 runtime en permanent."
...
firewall_port_runtime 8080/tcp || fail '8080 runtime missing'
firewall_port_permanent 8080/tcp || fail '8080 permanent missing'
pass '8080 open'
}
