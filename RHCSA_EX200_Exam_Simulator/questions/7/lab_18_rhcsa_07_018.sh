...
# LAB: Networking and firewalld firewall-rich 18
# Converted from qdir format: q018-rhcsa-07-018

IS_LAB=true
LAB_ID="rhcsa_07_018"
QUESTION="Networking and firewalld firewall-rich 18"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-rich 18"
