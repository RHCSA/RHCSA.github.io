#!/bin/bash
# Objective 7: networking, nmcli
# LAB: Networking and firewalld nmcli 27
# Converted from qdir format: q027-rhcsa-07-027

IS_LAB=true
LAB_ID="rhcsa_07_027"
QUESTION="Networking and firewalld nmcli 27"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld nmcli 27"
...
# Task 2
TASK_2_QUESTION="Maak NetworkManager connection rhcsa-static."
...
nm_connection_exists rhcsa-static || fail 'connection rhcsa-static missing'
pass 'nmcli connection exists'
}
