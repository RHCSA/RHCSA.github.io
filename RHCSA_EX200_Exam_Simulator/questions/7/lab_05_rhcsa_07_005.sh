...
# LAB: Networking and firewalld firewall-8080 5
# Converted from qdir format: q005-rhcsa-07-005

IS_LAB=true
LAB_ID="rhcsa_07_005"
QUESTION="Networking and firewalld firewall-8080 5"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-8080 5"
