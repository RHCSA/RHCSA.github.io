...
# LAB: Networking and firewalld nmcli 3
# Converted from qdir format: q003-rhcsa-07-003

IS_LAB=true
LAB_ID="rhcsa_07_003"
QUESTION="Networking and firewalld nmcli 3"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld nmcli 3"
