...
# LAB: Networking and firewalld hostname 19
# Converted from qdir format: q019-rhcsa-07-019

IS_LAB=true
LAB_ID="rhcsa_07_019"
QUESTION="Networking and firewalld hostname 19"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld hostname 19"
