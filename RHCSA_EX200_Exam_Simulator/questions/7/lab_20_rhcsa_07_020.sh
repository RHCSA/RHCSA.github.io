...
# LAB: Networking and firewalld dns 20
# Converted from qdir format: q020-rhcsa-07-020

IS_LAB=true
LAB_ID="rhcsa_07_020"
QUESTION="Networking and firewalld dns 20"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld dns 20"
