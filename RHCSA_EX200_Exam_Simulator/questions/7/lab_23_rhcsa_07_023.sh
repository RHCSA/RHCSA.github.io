...
# LAB: Networking and firewalld firewall-8080 23
# Converted from qdir format: q023-rhcsa-07-023

IS_LAB=true
LAB_ID="rhcsa_07_023"
QUESTION="Networking and firewalld firewall-8080 23"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-8080 23"
