...
# LAB: Networking and firewalld firewall-rich 24
# Converted from qdir format: q024-rhcsa-07-024

IS_LAB=true
LAB_ID="rhcsa_07_024"
QUESTION="Networking and firewalld firewall-rich 24"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-rich 24"
