...
# LAB: Networking and firewalld firewall-http 22
# Converted from qdir format: q022-rhcsa-07-022

IS_LAB=true
LAB_ID="rhcsa_07_022"
QUESTION="Networking and firewalld firewall-http 22"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld firewall-http 22"
...
# Task 2
TASK_2_QUESTION="Sta http permanent toe in firewalld."
...
firewall_service_permanent http || fail 'http service not permanent'
pass 'http service permanent'
}
