...
# LAB: Networking and firewalld dns 26
# Converted from qdir format: q026-rhcsa-07-026

IS_LAB=true
LAB_ID="rhcsa_07_026"
QUESTION="Networking and firewalld dns 26"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld dns 26"
...
# Task 2
TASK_2_QUESTION="Maak DNS-rapport in /root/reports/dns.txt."
...
[[ -s /root/reports/dns.txt ]] || fail 'DNS report missing'
pass 'DNS report exists'
}
