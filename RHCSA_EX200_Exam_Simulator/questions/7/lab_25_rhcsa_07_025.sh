...
# LAB: Networking and firewalld hostname 25
# Converted from qdir format: q025-rhcsa-07-025

IS_LAB=true
LAB_ID="rhcsa_07_025"
QUESTION="Networking and firewalld hostname 25"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld hostname 25"
...
# Task 2
TASK_2_QUESTION="Stel hostname persistent in op rhcsa.lab.local."
...
hostnamectl status | grep -q 'rhcsa.lab.local' || fail 'hostname not set'
pass 'hostname set'
}
