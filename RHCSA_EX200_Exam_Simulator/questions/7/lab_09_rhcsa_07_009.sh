...
# LAB: Networking and firewalld nmcli 9
# Converted from qdir format: q009-rhcsa-07-009

IS_LAB=true
LAB_ID="rhcsa_07_009"
QUESTION="Networking and firewalld nmcli 9"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Networking and firewalld nmcli 9"
