...
# LAB: Default target 16
# Converted from qdir format: q016-rhcsa-09-016

IS_LAB=true
LAB_ID="rhcsa_09_016"
QUESTION="Default target 16"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Default target 16"
