...
# LAB: Default target 11
# Converted from qdir format: q011-rhcsa-09-011

IS_LAB=true
LAB_ID="rhcsa_09_011"
QUESTION="Default target 11"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Default target 11"
...
# Task 2
TASK_2_QUESTION="Zet default target op multi-user.target."
...
default_target_is multi-user.target || fail 'default target is not multi-user.target'
pass 'default target correct'
}
