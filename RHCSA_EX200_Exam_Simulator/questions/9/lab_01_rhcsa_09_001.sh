...
# LAB: Default target 1
# Converted from qdir format: q001-rhcsa-09-001

IS_LAB=true
LAB_ID="rhcsa_09_001"
QUESTION="Default target 1"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Default target 1"
