...
# LAB: Emergency recovery notes 19
# Converted from qdir format: q019-rhcsa-09-019

IS_LAB=true
LAB_ID="rhcsa_09_019"
QUESTION="Emergency recovery notes 19"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Emergency recovery notes 19"
...
# Task 2
TASK_2_QUESTION="Maak /root/reports/recovery-notes.txt met rescue/emergency stappen."
...
[[ -s /root/reports/recovery-notes.txt ]] || fail 'recovery notes missing'
grep -Eiq 'emergency|rescue|rd.break|mount|chroot|passwd' /root/reports/recovery-notes.txt || fail 'notes incomplete'
pass 'recovery notes exist'
}
