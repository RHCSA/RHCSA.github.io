...
# LAB: Fstab sanity 17
# Converted from qdir format: q017-rhcsa-09-017

IS_LAB=true
LAB_ID="rhcsa_09_017"
QUESTION="Fstab sanity 17"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Fstab sanity 17"
...
# Task 2
TASK_2_QUESTION="Herstel fstab zodat findmnt --verify slaagt."
