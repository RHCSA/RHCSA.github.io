...
# LAB: Emergency recovery notes 14
# Converted from qdir format: q014-rhcsa-09-014

IS_LAB=true
LAB_ID="rhcsa_09_014"
QUESTION="Emergency recovery notes 14"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Emergency recovery notes 14"
