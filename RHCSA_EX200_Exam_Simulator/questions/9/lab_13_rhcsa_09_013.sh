...
# LAB: Grub report 13
# Converted from qdir format: q013-rhcsa-09-013

IS_LAB=true
LAB_ID="rhcsa_09_013"
QUESTION="Grub report 13"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Grub report 13"
...
# Task 2
TASK_2_QUESTION="Maak /root/reports/grub.txt met GRUB relevante informatie."
...
[[ -s /root/reports/grub.txt ]] || fail 'grub report missing'
pass 'grub report exists'
}
