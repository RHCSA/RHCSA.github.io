...
# LAB: Default target 6
# Converted from qdir format: q006-rhcsa-09-006

IS_LAB=true
LAB_ID="rhcsa_09_006"
QUESTION="Default target 6"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Default target 6"
