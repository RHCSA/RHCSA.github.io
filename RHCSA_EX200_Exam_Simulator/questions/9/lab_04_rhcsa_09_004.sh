...
# LAB: Emergency recovery notes 4
# Converted from qdir format: q004-rhcsa-09-004

IS_LAB=true
LAB_ID="rhcsa_09_004"
QUESTION="Emergency recovery notes 4"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Emergency recovery notes 4"
