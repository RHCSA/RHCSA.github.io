...
# LAB: Emergency recovery notes 9
# Converted from qdir format: q009-rhcsa-09-009

IS_LAB=true
LAB_ID="rhcsa_09_009"
QUESTION="Emergency recovery notes 9"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Emergency recovery notes 9"
