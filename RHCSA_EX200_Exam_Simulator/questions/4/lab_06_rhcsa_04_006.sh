#!/bin/bash
# Objective 4: lvcreate
# LAB: Create LV data
# Converted from qdir format: q006-rhcsa-04-006

IS_LAB=true
LAB_ID="rhcsa_04_006"
QUESTION="Create LV data"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Create LV data"
...
# Task 2
TASK_2_QUESTION="Maak logical volume /dev/research/data."
...
lv_exists /dev/research/data || fail 'LV /dev/research/data missing'
pass 'LV data exists'
}
