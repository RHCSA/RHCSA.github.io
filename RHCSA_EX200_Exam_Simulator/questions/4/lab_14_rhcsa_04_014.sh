#!/bin/bash
# Objective 4: mkfs_ext4
# LAB: Create ext4 filesystem
# Converted from qdir format: q014-rhcsa-04-014

IS_LAB=true
LAB_ID="rhcsa_04_014"
QUESTION="Create ext4 filesystem"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Create ext4 filesystem"
...
# Task 2
TASK_2_QUESTION="Maak een EXT4 filesystem en mount op /extdata."
...
mountpoint_exists /extdata || fail '/extdata not mounted'
findmnt -no FSTYPE /extdata | grep -Fx ext4 >/dev/null || fail '/extdata is not ext4'
pass 'EXT4 mounted'
}
