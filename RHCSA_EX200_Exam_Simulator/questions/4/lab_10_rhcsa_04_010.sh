#!/bin/bash
# Objective 4: stratis_fs
# LAB: Create Stratis filesystem
# Converted from qdir format: q010-rhcsa-04-010

IS_LAB=true
LAB_ID="rhcsa_04_010"
QUESTION="Create Stratis filesystem"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Create Stratis filesystem"
...
# Task 2
TASK_2_QUESTION="Maak Stratis filesystem strfs in pool strpool."
...
stratis filesystem list 2>/dev/null | grep -qw strfs || fail 'stratis filesystem strfs missing'
pass 'Stratis filesystem exists'
}
