#!/bin/bash
# Objective 4: pvcreate, vgcreate
# LAB: Create VG research
# Converted from qdir format: q005-rhcsa-04-005

IS_LAB=true
LAB_ID="rhcsa_04_005"
QUESTION="Create VG research"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Create VG research"
...
# Task 2
TASK_2_QUESTION="Maak volume group research aan."
...
vg_exists research || fail 'VG research missing'
pass 'VG research exists'
}
