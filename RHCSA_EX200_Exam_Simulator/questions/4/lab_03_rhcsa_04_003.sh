#!/bin/bash
# Objective 4: fstab, boot_recovery
# LAB: Repair fstab syntax
# Converted from qdir format: q003-rhcsa-04-003

IS_LAB=true
LAB_ID="rhcsa_04_003"
QUESTION="Repair fstab syntax"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Repair fstab syntax"
...
# Task 2
TASK_2_QUESTION="Repareer een foutieve fstab-regel zodat findmnt --verify slaagt."
...
fstab_sane || fail 'fstab verification failed'
pass 'fstab verified'
}
