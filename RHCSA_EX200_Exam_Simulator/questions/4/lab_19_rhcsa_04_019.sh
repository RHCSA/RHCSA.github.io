#!/bin/bash
# Objective 4: mount
# LAB: Repair missing mountpoint
# Converted from qdir format: q019-rhcsa-04-019

IS_LAB=true
LAB_ID="rhcsa_04_019"
QUESTION="Repair missing mountpoint"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Repair missing mountpoint"
...
# Task 2
TASK_2_QUESTION="Zorg dat /missingmnt bestaat en volgens fstab mountbaar is."
...
[[ -d /missingmnt ]] || fail 'mountpoint missing'
pass 'mountpoint exists'
}
