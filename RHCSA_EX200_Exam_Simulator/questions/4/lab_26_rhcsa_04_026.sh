#!/bin/bash
# Objective 4: lvm, fstab, xfs
# LAB: Exam storage scenario
# Converted from qdir format: q026-rhcsa-04-026

IS_LAB=true
LAB_ID="rhcsa_04_026"
QUESTION="Exam storage scenario"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Exam storage scenario"
...
# Task 2
TASK_2_QUESTION="Maak complete research storage: VG research, LV data, XFS, /research persistent."
...
vg_exists research || fail 'VG missing'
lv_exists /dev/research/data || fail 'LV missing'
mountpoint_exists /research || fail 'mount missing'
fstab_has_mount /research || fail 'fstab missing'
pass 'exam storage scenario complete'
}
