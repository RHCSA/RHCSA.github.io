#!/bin/bash
# Objective 4: fstab, uuid
# LAB: Persistent UUID mount
# Converted from qdir format: q002-rhcsa-04-002

IS_LAB=true
LAB_ID="rhcsa_04_002"
QUESTION="Persistent UUID mount"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Persistent UUID mount"
...
# Task 2
TASK_2_QUESTION="Maak /data persistent via UUID in /etc/fstab."
...
fstab_uses_uuid_for_mount /data || fail '/data is not mounted via UUID in fstab'
pass 'UUID mount found'
}
