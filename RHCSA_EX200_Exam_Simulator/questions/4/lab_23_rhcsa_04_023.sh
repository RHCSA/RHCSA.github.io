#!/bin/bash
# Objective 4: find, sort
# LAB: Find large files
# Converted from qdir format: q023-rhcsa-04-023

IS_LAB=true
LAB_ID="rhcsa_04_023"
QUESTION="Find large files"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Find large files"
...
# Task 2
TASK_2_QUESTION="Maak /root/reports/large-files.txt met bestanden groter dan 50M."
...
[[ -s /root/reports/large-files.txt ]] || fail 'large files report missing'
pass 'large files report exists'
}
