...
# Objective 4: quota
# LAB: Quota report
# Converted from qdir format: q022-rhcsa-04-022

IS_LAB=true
LAB_ID="rhcsa_04_022"
QUESTION="Quota report"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Quota report"
...
# Task 2
TASK_2_QUESTION="Maak /root/reports/quota.txt met quota relevante informatie."
...
[[ -s /root/reports/quota.txt ]] || fail 'quota report missing'
pass 'quota report exists'
}
