#!/bin/bash
# Objective 4: swap, fstab
# LAB: Exam swap scenario
# Converted from qdir format: q028-rhcsa-04-028

IS_LAB=true
LAB_ID="rhcsa_04_028"
QUESTION="Exam swap scenario"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Exam swap scenario"
...
# Task 2
TASK_2_QUESTION="Voeg 1G persistente swap toe via /swapfile."
...
swap_active /swapfile || fail 'swapfile inactive'
grep -q '^/swapfile' /etc/fstab || fail 'swapfile not persistent'
pass 'swap scenario complete'
}
