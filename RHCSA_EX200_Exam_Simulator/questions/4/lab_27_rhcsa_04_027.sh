#!/bin/bash
# Objective 4: fstab, troubleshooting
# LAB: Exam fstab rescue
# Converted from qdir format: q027-rhcsa-04-027

IS_LAB=true
LAB_ID="rhcsa_04_027"
QUESTION="Exam fstab rescue"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Exam fstab rescue"
...
# Task 2
TASK_2_QUESTION="Herstel fstab zodat systeem reboot-proof is."
...
fstab_sane || fail 'fstab not sane'
pass 'fstab sane'
}
