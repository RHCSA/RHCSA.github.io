#!/bin/bash
# Objective 4: stratis, fstab
# LAB: Persistent Stratis mount
# Converted from qdir format: q011-rhcsa-04-011

IS_LAB=true
LAB_ID="rhcsa_04_011"
QUESTION="Persistent Stratis mount"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Persistent Stratis mount"
...
# Task 2
TASK_2_QUESTION="Mount Stratis filesystem persistent op /stratisdata."
...
mountpoint_exists /stratisdata || fail '/stratisdata not mounted'
fstab_has_mount /stratisdata || fail '/stratisdata missing from fstab'
pass 'Stratis mount persistent'
}
