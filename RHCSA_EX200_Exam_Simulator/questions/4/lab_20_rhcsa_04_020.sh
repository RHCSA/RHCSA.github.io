#!/bin/bash
# Objective 4: uuid
# LAB: Use UUID not device path
# Converted from qdir format: q020-rhcsa-04-020

IS_LAB=true
LAB_ID="rhcsa_04_020"
QUESTION="Use UUID not device path"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Use UUID not device path"
...
# Task 2
TASK_2_QUESTION="Vervang device-pad mount voor /uuiddata door UUID."
...
fstab_uses_uuid_for_mount /uuiddata || fail '/uuiddata not mounted via UUID'
pass 'UUID used'
}
