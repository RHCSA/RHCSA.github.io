#!/bin/bash
# Objective 4: lvextend, xfs_growfs
# LAB: Extend LV and filesystem
# Converted from qdir format: q008-rhcsa-04-008

IS_LAB=true
LAB_ID="rhcsa_04_008"
QUESTION="Extend LV and filesystem"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Extend LV and filesystem"
...
# Task 2
TASK_2_QUESTION="Vergroot /research naar minimaal 1500M en grow filesystem."
...
size=$(df -m /research 2>/dev/null | awk 'NR==2{print $2}'); [[ ${size:-0} -ge 1400 ]] || fail '/research smaller than expected'
pass 'filesystem extended'
}
