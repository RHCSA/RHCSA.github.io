...
# Converted from qdir format: q004-rhcsa-04-004

IS_LAB=true
LAB_ID="rhcsa_04_004"
QUESTION="Create swap file"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Create swap file"
...
# Task 2
TASK_2_QUESTION="Maak /swapfile van 512M en activeer deze."
...
swap_active /swapfile || fail '/swapfile not active as swap'
grep -E '^/swapfile[[:space:]]+none[[:space:]]+swap' /etc/fstab >/dev/null || fail '/swapfile not persistent in fstab'
pass 'swapfile active and persistent'
}
