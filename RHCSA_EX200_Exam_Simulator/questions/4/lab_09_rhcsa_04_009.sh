#!/bin/bash
# Objective 4: stratis
# LAB: Create Stratis pool
# Converted from qdir format: q009-rhcsa-04-009

IS_LAB=true
LAB_ID="rhcsa_04_009"
QUESTION="Create Stratis pool"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Create Stratis pool"
...
# Task 2
TASK_2_QUESTION="Maak Stratis pool strpool."
...
stratis pool list 2>/dev/null | grep -qw strpool || fail 'stratis pool strpool missing'
pass 'Stratis pool exists'
}
