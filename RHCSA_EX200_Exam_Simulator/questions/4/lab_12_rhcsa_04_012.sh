#!/bin/bash
# Objective 4: blkid, lsblk
# LAB: Detect filesystem types
# Converted from qdir format: q012-rhcsa-04-012

IS_LAB=true
LAB_ID="rhcsa_04_012"
QUESTION="Detect filesystem types"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Detect filesystem types"
...
# Task 2
TASK_2_QUESTION="Genereer /root/reports/filesystems.txt met filesystemtypes."
...
[[ -s /root/reports/filesystems.txt ]] || fail 'report missing'
grep -Eiq 'xfs|ext4|swap' /root/reports/filesystems.txt || fail 'report lacks filesystem data'
pass 'filesystem report exists'
}
