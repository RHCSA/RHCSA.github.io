#!/bin/bash
# Objective 4: stratis
# LAB: Exam Stratis scenario
# Converted from qdir format: q029-rhcsa-04-029

IS_LAB=true
LAB_ID="rhcsa_04_029"
QUESTION="Exam Stratis scenario"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Exam Stratis scenario"
...
# Task 2
TASK_2_QUESTION="Maak Stratis pool/filesystem en mount op /projectdata."
...
mountpoint_exists /projectdata || fail '/projectdata not mounted'
fstab_has_mount /projectdata || fail '/projectdata not persistent'
pass 'Stratis exam scenario complete'
}
