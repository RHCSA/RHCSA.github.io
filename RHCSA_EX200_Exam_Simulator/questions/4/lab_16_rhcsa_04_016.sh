#!/bin/bash
# Objective 4: autofs
# LAB: Autofs placeholder check
# Converted from qdir format: q016-rhcsa-04-016

IS_LAB=true
LAB_ID="rhcsa_04_016"
QUESTION="Autofs placeholder check"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Autofs placeholder check"
...
# Task 2
TASK_2_QUESTION="Maak een autofs configuratierapport in /root/reports/autofs.txt."
...
[[ -s /root/reports/autofs.txt ]] || fail 'autofs report missing'
pass 'autofs report exists'
}
