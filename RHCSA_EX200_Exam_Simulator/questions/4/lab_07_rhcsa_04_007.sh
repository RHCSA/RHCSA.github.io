#!/bin/bash
# Objective 4: lvm, fstab
# LAB: Mount LV on research
# Converted from qdir format: q007-rhcsa-04-007

IS_LAB=true
LAB_ID="rhcsa_04_007"
QUESTION="Mount LV on research"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Mount LV on research"
...
# Task 2
TASK_2_QUESTION="Formatteer LV data als XFS en mount persistent op /research."
...
mountpoint_exists /research || fail '/research not mounted'
findmnt -no FSTYPE /research | grep -Fx xfs >/dev/null || fail '/research not XFS'
fstab_has_mount /research || fail '/research not in fstab'
pass 'LV mounted persistently'
}
