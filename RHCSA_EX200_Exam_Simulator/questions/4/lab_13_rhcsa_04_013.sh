#!/bin/bash
# Objective 4: df, du
# LAB: Disk usage report
# Converted from qdir format: q013-rhcsa-04-013

IS_LAB=true
LAB_ID="rhcsa_04_013"
QUESTION="Disk usage report"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Disk usage report"
...
# Task 2
TASK_2_QUESTION="Maak /root/reports/disk-usage.txt met df en du informatie."
...
[[ -s /root/reports/disk-usage.txt ]] || fail 'disk usage report missing'
grep -Eq 'Filesystem|/root|/var|/home' /root/reports/disk-usage.txt || fail 'report incomplete'
pass 'disk usage report exists'
}
