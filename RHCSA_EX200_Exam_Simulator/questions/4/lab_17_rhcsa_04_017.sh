...
# LAB: LVM snapshot
# Converted from qdir format: q017-rhcsa-04-017

IS_LAB=true
LAB_ID="rhcsa_04_017"
QUESTION="LVM snapshot"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: LVM snapshot"
...
# Task 2
TASK_2_QUESTION="Maak snapshot /dev/research/data_snap."
...
lv_exists /dev/research/data_snap || fail 'snapshot LV missing'
