#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak calculator 22
# Converted from qdir format: q022-rhcsa-08-022

IS_LAB=true
LAB_ID="rhcsa_08_022"
QUESTION="Flatpak calculator 22"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak calculator 22"
