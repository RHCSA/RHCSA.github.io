#!/bin/bash
# Objective 8: dnf
# LAB: DNF install httpd 1
# Converted from qdir format: q001-rhcsa-08-001

IS_LAB=true
LAB_ID="rhcsa_08_001"
QUESTION="DNF install httpd 1"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: DNF install httpd 1"
