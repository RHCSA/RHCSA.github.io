#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak firefox 5
# Converted from qdir format: q005-rhcsa-08-005

IS_LAB=true
LAB_ID="rhcsa_08_005"
QUESTION="Flatpak firefox 5"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak firefox 5"
