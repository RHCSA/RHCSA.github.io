#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak remote 4
# Converted from qdir format: q004-rhcsa-08-004

IS_LAB=true
LAB_ID="rhcsa_08_004"
QUESTION="Flatpak remote 4"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak remote 4"
