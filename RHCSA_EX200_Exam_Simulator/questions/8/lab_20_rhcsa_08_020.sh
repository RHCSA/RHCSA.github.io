#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak remote 20
# Converted from qdir format: q020-rhcsa-08-020

IS_LAB=true
LAB_ID="rhcsa_08_020"
QUESTION="Flatpak remote 20"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak remote 20"
...
# Task 2
TASK_2_QUESTION="Voeg remote flathub toe."
...
flatpak_remote_exists flathub || fail 'flathub remote missing'
pass 'flathub exists'
}
