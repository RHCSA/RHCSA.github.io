#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak firefox 29
# Converted from qdir format: q029-rhcsa-08-029

IS_LAB=true
LAB_ID="rhcsa_08_029"
QUESTION="Flatpak firefox 29"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak firefox 29"
...
# Task 2
TASK_2_QUESTION="Installeer org.mozilla.firefox via flatpak."
...
flatpak_app_installed org.mozilla.firefox || fail 'Firefox flatpak missing'
pass 'Firefox flatpak installed'
}
