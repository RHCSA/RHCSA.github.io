#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak remote 28
# Converted from qdir format: q028-rhcsa-08-028

IS_LAB=true
LAB_ID="rhcsa_08_028"
QUESTION="Flatpak remote 28"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak remote 28"
