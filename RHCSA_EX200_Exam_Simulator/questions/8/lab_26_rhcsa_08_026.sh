...
# LAB: DNF provides tree 26
# Converted from qdir format: q026-rhcsa-08-026

IS_LAB=true
LAB_ID="rhcsa_08_026"
QUESTION="DNF provides tree 26"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: DNF provides tree 26"
