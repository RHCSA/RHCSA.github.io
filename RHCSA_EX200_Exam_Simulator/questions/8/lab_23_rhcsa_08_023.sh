#!/bin/bash
# Objective 8: flatpak, user_scope
# LAB: Flatpak user scope 23
# Converted from qdir format: q023-rhcsa-08-023

IS_LAB=true
LAB_ID="rhcsa_08_023"
QUESTION="Flatpak user scope 23"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak user scope 23"
...
# Task 2
TASK_2_QUESTION="Installeer org.gnome.Calculator in user scope."
...
flatpak_app_installed_user org.gnome.Calculator || fail 'Calculator not installed in user scope'
pass 'user scope flatpak installed'
}
