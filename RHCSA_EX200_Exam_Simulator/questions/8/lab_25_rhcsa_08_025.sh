#!/bin/bash
# Objective 8: dnf
# LAB: DNF install httpd 25
# Converted from qdir format: q025-rhcsa-08-025

IS_LAB=true
LAB_ID="rhcsa_08_025"
QUESTION="DNF install httpd 25"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: DNF install httpd 25"
