#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak calculator 14
# Converted from qdir format: q014-rhcsa-08-014

IS_LAB=true
LAB_ID="rhcsa_08_014"
QUESTION="Flatpak calculator 14"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak calculator 14"
...
# Task 2
TASK_2_QUESTION="Installeer org.gnome.Calculator via flatpak."
...
flatpak_app_installed org.gnome.Calculator || fail 'Calculator flatpak missing'
pass 'Calculator flatpak installed'
}
