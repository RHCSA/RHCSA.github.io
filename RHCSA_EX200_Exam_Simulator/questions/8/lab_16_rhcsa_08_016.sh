...
# LAB: Flatpak audit 16
# Converted from qdir format: q016-rhcsa-08-016

IS_LAB=true
LAB_ID="rhcsa_08_016"
QUESTION="Flatpak audit 16"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak audit 16"
