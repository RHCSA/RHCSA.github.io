...
# LAB: DNF provides tree 2
# Converted from qdir format: q002-rhcsa-08-002

IS_LAB=true
LAB_ID="rhcsa_08_002"
QUESTION="DNF provides tree 2"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: DNF provides tree 2"
