#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak firefox 21
# Converted from qdir format: q021-rhcsa-08-021

IS_LAB=true
LAB_ID="rhcsa_08_021"
QUESTION="Flatpak firefox 21"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak firefox 21"
