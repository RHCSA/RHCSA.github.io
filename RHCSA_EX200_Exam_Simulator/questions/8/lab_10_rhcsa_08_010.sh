#!/bin/bash
# Objective 8: dnf, repoquery
# LAB: DNF provides tree 10
# Converted from qdir format: q010-rhcsa-08-010

IS_LAB=true
LAB_ID="rhcsa_08_010"
QUESTION="DNF provides tree 10"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: DNF provides tree 10"
...
# Task 2
TASK_2_QUESTION="Maak /root/reports/dnf-provides-tree.txt met dnf provides output voor /usr/bin/tree."
...
[[ -s /root/reports/dnf-provides-tree.txt ]] || fail 'dnf provides report missing'
pass 'dnf provides report exists'
}
