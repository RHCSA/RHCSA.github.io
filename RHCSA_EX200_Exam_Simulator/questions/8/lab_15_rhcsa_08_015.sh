...
# LAB: Flatpak user scope 15
# Converted from qdir format: q015-rhcsa-08-015

IS_LAB=true
LAB_ID="rhcsa_08_015"
QUESTION="Flatpak user scope 15"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak user scope 15"
