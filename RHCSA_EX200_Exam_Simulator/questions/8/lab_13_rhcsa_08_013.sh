#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak firefox 13
# Converted from qdir format: q013-rhcsa-08-013

IS_LAB=true
LAB_ID="rhcsa_08_013"
QUESTION="Flatpak firefox 13"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak firefox 13"
