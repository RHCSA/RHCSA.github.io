#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak calculator 30
# Converted from qdir format: q030-rhcsa-08-030

IS_LAB=true
LAB_ID="rhcsa_08_030"
QUESTION="Flatpak calculator 30"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak calculator 30"
