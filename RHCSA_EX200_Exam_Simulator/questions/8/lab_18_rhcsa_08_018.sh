...
# LAB: DNF provides tree 18
# Converted from qdir format: q018-rhcsa-08-018

IS_LAB=true
LAB_ID="rhcsa_08_018"
QUESTION="DNF provides tree 18"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: DNF provides tree 18"
