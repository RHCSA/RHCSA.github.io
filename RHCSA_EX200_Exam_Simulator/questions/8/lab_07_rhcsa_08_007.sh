...
# LAB: Flatpak user scope 7
# Converted from qdir format: q007-rhcsa-08-007

IS_LAB=true
LAB_ID="rhcsa_08_007"
QUESTION="Flatpak user scope 7"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak user scope 7"
