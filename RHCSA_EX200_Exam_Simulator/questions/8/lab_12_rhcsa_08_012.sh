#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak remote 12
# Converted from qdir format: q012-rhcsa-08-012

IS_LAB=true
LAB_ID="rhcsa_08_012"
QUESTION="Flatpak remote 12"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak remote 12"
