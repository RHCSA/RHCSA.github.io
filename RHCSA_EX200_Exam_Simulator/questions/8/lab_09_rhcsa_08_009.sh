#!/bin/bash
# Objective 8: dnf
# LAB: DNF install httpd 9
# Converted from qdir format: q009-rhcsa-08-009

IS_LAB=true
LAB_ID="rhcsa_08_009"
QUESTION="DNF install httpd 9"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: DNF install httpd 9"
