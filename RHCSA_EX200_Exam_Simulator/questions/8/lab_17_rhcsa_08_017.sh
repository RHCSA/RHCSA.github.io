#!/bin/bash
# Objective 8: dnf
# LAB: DNF install httpd 17
# Converted from qdir format: q017-rhcsa-08-017

IS_LAB=true
LAB_ID="rhcsa_08_017"
QUESTION="DNF install httpd 17"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: DNF install httpd 17"
...
# Task 2
TASK_2_QUESTION="Installeer pakket httpd."
...
rpm -q httpd >/dev/null 2>&1 || fail 'httpd not installed'
pass 'httpd installed'
}
