#!/bin/bash
# Objective 8: flatpak
# LAB: Flatpak calculator 6
# Converted from qdir format: q006-rhcsa-08-006

IS_LAB=true
LAB_ID="rhcsa_08_006"
QUESTION="Flatpak calculator 6"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Flatpak calculator 6"
