...
# LAB: Full RHCSA scenario 18
# Converted from qdir format: q018-rhcsa-10-018

IS_LAB=true
LAB_ID="rhcsa_10_018"
QUESTION="Full RHCSA scenario 18"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Full RHCSA scenario 18"
...
# Task 2
TASK_2_QUESTION="Voer geïntegreerd RHCSA scenario 18 uit: users, scripts, storage, SELinux/systemd/networking of Flatpak volgens question.md."
...
[[ -s /root/reports/exam-scenario-18.txt ]] || fail 'scenario report missing'
grep -Eiq 'PASS|completed|storage|selinux|systemd|network|flatpak|user' /root/reports/exam-scenario-18.txt || fail 'scenario report incomplete'
pass 'full exam scenario 18 complete'
}
...
cleanup_lab() {
set +e
rm -f /root/reports/exam-scenario-18.txt
