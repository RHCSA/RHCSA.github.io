...
# LAB: Full RHCSA scenario 24
# Converted from qdir format: q024-rhcsa-10-024

IS_LAB=true
LAB_ID="rhcsa_10_024"
QUESTION="Full RHCSA scenario 24"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Full RHCSA scenario 24"
...
# Task 2
TASK_2_QUESTION="Voer geïntegreerd RHCSA scenario 24 uit: users, scripts, storage, SELinux/systemd/networking of Flatpak volgens question.md."
...
[[ -s /root/reports/exam-scenario-24.txt ]] || fail 'scenario report missing'
grep -Eiq 'PASS|completed|storage|selinux|systemd|network|flatpak|user' /root/reports/exam-scenario-24.txt || fail 'scenario report incomplete'
pass 'full exam scenario 24 complete'
}
...
cleanup_lab() {
set +e
rm -f /root/reports/exam-scenario-24.txt
