...
# LAB: Full RHCSA scenario 16
# Converted from qdir format: q016-rhcsa-10-016

IS_LAB=true
LAB_ID="rhcsa_10_016"
QUESTION="Full RHCSA scenario 16"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Full RHCSA scenario 16"
...
# Task 2
TASK_2_QUESTION="Voer geïntegreerd RHCSA scenario 16 uit: users, scripts, storage, SELinux/systemd/networking of Flatpak volgens question.md."
...
[[ -s /root/reports/exam-scenario-16.txt ]] || fail 'scenario report missing'
grep -Eiq 'PASS|completed|storage|selinux|systemd|network|flatpak|user' /root/reports/exam-scenario-16.txt || fail 'scenario report incomplete'
pass 'full exam scenario 16 complete'
}
...
cleanup_lab() {
set +e
rm -f /root/reports/exam-scenario-16.txt
