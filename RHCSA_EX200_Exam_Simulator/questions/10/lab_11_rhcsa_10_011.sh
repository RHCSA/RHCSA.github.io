...
# LAB: Full RHCSA scenario 11
# Converted from qdir format: q011-rhcsa-10-011

IS_LAB=true
LAB_ID="rhcsa_10_011"
QUESTION="Full RHCSA scenario 11"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Full RHCSA scenario 11"
...
# Task 2
TASK_2_QUESTION="Voer geïntegreerd RHCSA scenario 11 uit: users, scripts, storage, SELinux/systemd/networking of Flatpak volgens question.md."
...
[[ -s /root/reports/exam-scenario-11.txt ]] || fail 'scenario report missing'
grep -Eiq 'PASS|completed|storage|selinux|systemd|network|flatpak|user' /root/reports/exam-scenario-11.txt || fail 'scenario report incomplete'
pass 'full exam scenario 11 complete'
}
...
cleanup_lab() {
set +e
rm -f /root/reports/exam-scenario-11.txt
