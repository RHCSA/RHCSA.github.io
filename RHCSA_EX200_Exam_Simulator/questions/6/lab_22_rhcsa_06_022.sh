...
# LAB: Exam systemd scenario 22
# Converted from qdir format: q022-rhcsa-06-022

IS_LAB=true
LAB_ID="rhcsa_06_022"
QUESTION="Exam systemd scenario 22"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Exam systemd scenario 22"
...
# Task 2
TASK_2_QUESTION="Los systemd scenario op: exam-app-22.service moet bestaan, enabled zijn en journald logging hebben."
...
[[ -f /etc/systemd/system/exam-app-22.service ]] || fail 'exam service missing'
systemctl daemon-reload
unit_enabled exam-app-22.service || fail 'exam service not enabled'
