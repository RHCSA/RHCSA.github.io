...
# LAB: Exam systemd scenario 25
# Converted from qdir format: q025-rhcsa-06-025

IS_LAB=true
LAB_ID="rhcsa_06_025"
QUESTION="Exam systemd scenario 25"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Exam systemd scenario 25"
...
# Task 2
TASK_2_QUESTION="Los systemd scenario op: exam-app-25.service moet bestaan, enabled zijn en journald logging hebben."
...
[[ -f /etc/systemd/system/exam-app-25.service ]] || fail 'exam service missing'
systemctl daemon-reload
unit_enabled exam-app-25.service || fail 'exam service not enabled'
