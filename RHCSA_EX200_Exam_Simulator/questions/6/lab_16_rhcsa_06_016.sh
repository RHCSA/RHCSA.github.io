...
# LAB: Journald troubleshooting 16
# Converted from qdir format: q016-rhcsa-06-016

IS_LAB=true
LAB_ID="rhcsa_06_016"
QUESTION="Journald troubleshooting 16"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Journald troubleshooting 16"
