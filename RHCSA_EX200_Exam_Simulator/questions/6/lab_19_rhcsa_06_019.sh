...
# LAB: Journald troubleshooting 19
# Converted from qdir format: q019-rhcsa-06-019

IS_LAB=true
LAB_ID="rhcsa_06_019"
QUESTION="Journald troubleshooting 19"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Journald troubleshooting 19"
