...
# LAB: Manage service state 4
# Converted from qdir format: q004-rhcsa-06-004

IS_LAB=true
LAB_ID="rhcsa_06_004"
QUESTION="Manage service state 4"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Manage service state 4"
