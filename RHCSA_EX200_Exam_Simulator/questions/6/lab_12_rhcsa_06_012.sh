...
# LAB: Systemd timer lab 12
# Converted from qdir format: q012-rhcsa-06-012

IS_LAB=true
LAB_ID="rhcsa_06_012"
QUESTION="Systemd timer lab 12"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Systemd timer lab 12"
...
# Task 2
TASK_2_QUESTION="Maak en enable rhcsa-timer-12.timer."
...
[[ -f /etc/systemd/system/rhcsa-timer-12.timer ]] || fail 'timer missing'
systemctl daemon-reload
timer_enabled rhcsa-timer-12.timer || fail 'timer not enabled'
pass 'timer enabled'
}
