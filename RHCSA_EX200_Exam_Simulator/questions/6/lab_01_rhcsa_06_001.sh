...
# LAB: Manage service state 1
# Converted from qdir format: q001-rhcsa-06-001

IS_LAB=true
LAB_ID="rhcsa_06_001"
QUESTION="Manage service state 1"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Manage service state 1"
