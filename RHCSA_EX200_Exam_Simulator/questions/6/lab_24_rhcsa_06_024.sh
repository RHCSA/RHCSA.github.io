...
# LAB: Exam systemd scenario 24
# Converted from qdir format: q024-rhcsa-06-024

IS_LAB=true
LAB_ID="rhcsa_06_024"
QUESTION="Exam systemd scenario 24"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Exam systemd scenario 24"
...
# Task 2
TASK_2_QUESTION="Los systemd scenario op: exam-app-24.service moet bestaan, enabled zijn en journald logging hebben."
...
[[ -f /etc/systemd/system/exam-app-24.service ]] || fail 'exam service missing'
systemctl daemon-reload
unit_enabled exam-app-24.service || fail 'exam service not enabled'
pass 'exam systemd scenario passed'
}
