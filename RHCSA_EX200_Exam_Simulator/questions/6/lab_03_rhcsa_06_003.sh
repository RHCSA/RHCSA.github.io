...
# LAB: Manage service state 3
# Converted from qdir format: q003-rhcsa-06-003

IS_LAB=true
LAB_ID="rhcsa_06_003"
QUESTION="Manage service state 3"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Manage service state 3"
