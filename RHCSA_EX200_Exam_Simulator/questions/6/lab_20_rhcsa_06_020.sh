...
# LAB: Journald troubleshooting 20
# Converted from qdir format: q020-rhcsa-06-020

IS_LAB=true
LAB_ID="rhcsa_06_020"
QUESTION="Journald troubleshooting 20"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Journald troubleshooting 20"
