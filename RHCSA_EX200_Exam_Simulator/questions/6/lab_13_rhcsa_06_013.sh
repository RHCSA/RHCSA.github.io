...
# LAB: Systemd timer lab 13
# Converted from qdir format: q013-rhcsa-06-013

IS_LAB=true
LAB_ID="rhcsa_06_013"
QUESTION="Systemd timer lab 13"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Systemd timer lab 13"
...
# Task 2
TASK_2_QUESTION="Maak en enable rhcsa-timer-13.timer."
...
[[ -f /etc/systemd/system/rhcsa-timer-13.timer ]] || fail 'timer missing'
systemctl daemon-reload
timer_enabled rhcsa-timer-13.timer || fail 'timer not enabled'
pass 'timer enabled'
}
