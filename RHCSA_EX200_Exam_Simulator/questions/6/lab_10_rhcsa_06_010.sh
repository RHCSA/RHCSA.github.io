...
# LAB: Create custom oneshot service 10
# Converted from qdir format: q010-rhcsa-06-010

IS_LAB=true
LAB_ID="rhcsa_06_010"
QUESTION="Create custom oneshot service 10"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Create custom oneshot service 10"
...
# Task 2
TASK_2_QUESTION="Maak systemd oneshot service rhcsa-demo-10.service die /usr/local/bin/rhcsa-demo-10.sh uitvoert."
...
[[ -f /etc/systemd/system/rhcsa-demo-10.service ]] || fail 'unit missing'
systemctl daemon-reload
unit_exists rhcsa-demo-10.service || fail 'unit not known'
pass 'custom service exists'
}
