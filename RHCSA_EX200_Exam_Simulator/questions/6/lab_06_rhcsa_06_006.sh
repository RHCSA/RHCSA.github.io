...
# LAB: Create custom oneshot service 6
# Converted from qdir format: q006-rhcsa-06-006

IS_LAB=true
LAB_ID="rhcsa_06_006"
QUESTION="Create custom oneshot service 6"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Create custom oneshot service 6"
...
# Task 2
TASK_2_QUESTION="Maak systemd oneshot service rhcsa-demo-6.service die /usr/local/bin/rhcsa-demo-6.sh uitvoert."
...
[[ -f /etc/systemd/system/rhcsa-demo-6.service ]] || fail 'unit missing'
systemctl daemon-reload
unit_exists rhcsa-demo-6.service || fail 'unit not known'
