...
# LAB: Systemd timer lab 15
# Converted from qdir format: q015-rhcsa-06-015

IS_LAB=true
LAB_ID="rhcsa_06_015"
QUESTION="Systemd timer lab 15"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Systemd timer lab 15"
...
# Task 2
TASK_2_QUESTION="Maak en enable rhcsa-timer-15.timer."
...
[[ -f /etc/systemd/system/rhcsa-timer-15.timer ]] || fail 'timer missing'
systemctl daemon-reload
timer_enabled rhcsa-timer-15.timer || fail 'timer not enabled'
pass 'timer enabled'
}
