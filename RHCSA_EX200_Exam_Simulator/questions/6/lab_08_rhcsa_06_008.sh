...
# LAB: Create custom oneshot service 8
# Converted from qdir format: q008-rhcsa-06-008

IS_LAB=true
LAB_ID="rhcsa_06_008"
QUESTION="Create custom oneshot service 8"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Create custom oneshot service 8"
...
# Task 2
TASK_2_QUESTION="Maak systemd oneshot service rhcsa-demo-8.service die /usr/local/bin/rhcsa-demo-8.sh uitvoert."
...
[[ -f /etc/systemd/system/rhcsa-demo-8.service ]] || fail 'unit missing'
systemctl daemon-reload
unit_exists rhcsa-demo-8.service || fail 'unit not known'
