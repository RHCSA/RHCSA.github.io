...
# LAB: Systemd timer lab 11
# Converted from qdir format: q011-rhcsa-06-011

IS_LAB=true
LAB_ID="rhcsa_06_011"
QUESTION="Systemd timer lab 11"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Systemd timer lab 11"
...
# Task 2
TASK_2_QUESTION="Maak en enable rhcsa-timer-11.timer."
...
[[ -f /etc/systemd/system/rhcsa-timer-11.timer ]] || fail 'timer missing'
systemctl daemon-reload
timer_enabled rhcsa-timer-11.timer || fail 'timer not enabled'
pass 'timer enabled'
}
