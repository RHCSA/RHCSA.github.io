...
# LAB: Exam systemd scenario 21
# Converted from qdir format: q021-rhcsa-06-021

IS_LAB=true
LAB_ID="rhcsa_06_021"
QUESTION="Exam systemd scenario 21"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Exam systemd scenario 21"
...
# Task 2
TASK_2_QUESTION="Los systemd scenario op: exam-app-21.service moet bestaan, enabled zijn en journald logging hebben."
...
[[ -f /etc/systemd/system/exam-app-21.service ]] || fail 'exam service missing'
systemctl daemon-reload
unit_enabled exam-app-21.service || fail 'exam service not enabled'
