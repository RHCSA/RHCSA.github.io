...
# LAB: Systemd timer lab 14
# Converted from qdir format: q014-rhcsa-06-014

IS_LAB=true
LAB_ID="rhcsa_06_014"
QUESTION="Systemd timer lab 14"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Systemd timer lab 14"
...
# Task 2
TASK_2_QUESTION="Maak en enable rhcsa-timer-14.timer."
...
[[ -f /etc/systemd/system/rhcsa-timer-14.timer ]] || fail 'timer missing'
systemctl daemon-reload
timer_enabled rhcsa-timer-14.timer || fail 'timer not enabled'
pass 'timer enabled'
}
