...
# LAB: Create custom oneshot service 7
# Converted from qdir format: q007-rhcsa-06-007

IS_LAB=true
LAB_ID="rhcsa_06_007"
QUESTION="Create custom oneshot service 7"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Create custom oneshot service 7"
...
# Task 2
TASK_2_QUESTION="Maak systemd oneshot service rhcsa-demo-7.service die /usr/local/bin/rhcsa-demo-7.sh uitvoert."
...
[[ -f /etc/systemd/system/rhcsa-demo-7.service ]] || fail 'unit missing'
systemctl daemon-reload
unit_exists rhcsa-demo-7.service || fail 'unit not known'
