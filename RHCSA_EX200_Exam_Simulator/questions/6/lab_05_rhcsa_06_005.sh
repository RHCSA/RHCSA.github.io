...
# LAB: Manage service state 5
# Converted from qdir format: q005-rhcsa-06-005

IS_LAB=true
LAB_ID="rhcsa_06_005"
QUESTION="Manage service state 5"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Manage service state 5"
...
# Task 2
TASK_2_QUESTION="Voer een systemctl beheeractie uit en maak een rapport in /root/reports/service-state.txt."
...
[[ -s /root/reports/service-state.txt ]] || fail 'service report missing'
pass 'service report found'
}
