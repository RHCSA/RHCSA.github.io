...
# LAB: Create custom oneshot service 9
# Converted from qdir format: q009-rhcsa-06-009

IS_LAB=true
LAB_ID="rhcsa_06_009"
QUESTION="Create custom oneshot service 9"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Create custom oneshot service 9"
...
# Task 2
TASK_2_QUESTION="Maak systemd oneshot service rhcsa-demo-9.service die /usr/local/bin/rhcsa-demo-9.sh uitvoert."
...
[[ -f /etc/systemd/system/rhcsa-demo-9.service ]] || fail 'unit missing'
systemctl daemon-reload
unit_exists rhcsa-demo-9.service || fail 'unit not known'
