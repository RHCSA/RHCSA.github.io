...
# LAB: Manage service state 2
# Converted from qdir format: q002-rhcsa-06-002

IS_LAB=true
LAB_ID="rhcsa_06_002"
QUESTION="Manage service state 2"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Manage service state 2"
