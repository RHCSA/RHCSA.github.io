...
# LAB: Journald troubleshooting 18
# Converted from qdir format: q018-rhcsa-06-018

IS_LAB=true
LAB_ID="rhcsa_06_018"
QUESTION="Journald troubleshooting 18"

LAB_TASK_COUNT=3

# Task 1
TASK_1_QUESTION="Prepare the lab environment for: Journald troubleshooting 18"
